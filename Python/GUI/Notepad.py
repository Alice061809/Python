...
root = Tk() 
root.title(f"ALICE NOTEPAD - {filename}")
...
def open_file():
    ...
    filename = filedialog.askopenfilename(title="Open txt file", 
                                          ...
                                          initialdir="/Users/alicechung/Desktop/vscoding/Python/GUI/GUI_tool.py")
...
def browse_dest_path():
    filesave = filedialog.asksaveasfilename(title="Save txt file", 
